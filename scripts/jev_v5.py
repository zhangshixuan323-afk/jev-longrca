"""JEV Choice v5: original prompts, adaptive retention and bounded selection history."""
import copy
import json
import math
...
PROTOCOL = "jev-v1-prompts-adaptive-v5"
MODEL = baseline.MODEL
PROMPT_FILE = ROOT / "prompts/jev_v5.json"
APPROVED_FILE = ROOT / "reports/jev_v5_prompts.md"
...
def load_prompts(path=PROMPT_FILE):
    ...
    if bundle.get("protocol") != PROTOCOL or bundle.get("prompts") != expected_prompts():
        raise ValueError("All v5 instructions must exactly match the original v1 Choice prompts")
